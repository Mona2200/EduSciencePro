...
namespace EduSciencePro.Data.Repos
{
    public class ProjectRepository : IProjectRepository
    {
        ...
        public async Task<Skill[]> GetSkillsSearch(string str) => await _db.Skills.Where(t => t.Name.ToLower().Contains(str.ToLower())).ToArrayAsync();
    }
    ...
    public interface IProjectRepository
    {
        ...
        Task Delete(Guid id);
        Task<Skill[]> GetSkillsSearch(string str);
    }
}
